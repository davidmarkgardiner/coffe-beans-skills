          ...
          <div>
            ...
            <form className="flex flex-col gap-2">
              <input
                ...
                className="px-4 py-2 rounded-lg bg-surface border border-accent text-heading placeholder-text/50 focus:outline-none focus:ring-2 focus:ring-accent transition-all duration-200"
              />
              <button
                type="submit"
