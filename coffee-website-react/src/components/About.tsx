      ...
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-6 mt-8">
              <div className="text-center">
                <p className="font-display text-4xl font-bold text-heading mb-2">15+</p>
                <p className="text-sm text-text">Countries</p>
              </div>
              <div className="text-center">
                <p className="font-display text-4xl font-bold text-heading mb-2">50K+</p>
                <p className="text-sm text-text">Happy Customers</p>
              </div>
              <div className="text-center">
                <p className="font-display text-4xl font-bold text-heading mb-2">100%</p>
          ...
          >
            ...
            <div className="absolute -bottom-8 -left-8 bg-heading text-contrast p-8 rounded-2xl shadow-xl max-w-xs">
