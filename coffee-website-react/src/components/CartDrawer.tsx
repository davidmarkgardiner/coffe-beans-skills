        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              exit={{ opacity: 0 }}
              onClick={onClose}
              className="fixed inset-0 bg-heading/70 z-40"
            />
            ...
            >
              ...
              <div className="flex items-center justify-between p-6 border-b border-border">
                ...
                <button
                  onClick={onClose}
                  className="p-2 hover:bg-contrast-alt/40 rounded-full transition-colors"
              ...
              <div className="flex-1 overflow-y-auto p-6">
                {cart.length === 0 ? (
                  <div className="flex flex-col items-center justify-center h-full text-center text-text">
                    <ShoppingBag className="w-16 h-16 text-muted/40 mb-4" />
                  ...
                  <div className="space-y-4">
                    {cart.map((item) => (
                      <motion.div
                        ...
                        className="flex gap-4 p-4 bg-surface rounded-lg border border-border/70"
                      >
                        {/* Product Image */}
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-2">
                              <button
                                ...
                                className="p-1 hover:bg-contrast-alt rounded transition-colors"
              ...
              {cart.length > 0 && (
                <div className="border-t border-border p-6 bg-surface">
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="w-full py-4 bg-accent text-heading rounded-lg font-semibold text-lg hover:bg-accent-hover transition-colors shadow-medium hover:shadow-large"
                  >
                    Proceed to Checkout
                  </motion.button>
